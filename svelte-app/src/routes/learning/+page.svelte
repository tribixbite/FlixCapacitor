    ...
    <div class="px-4 pt-4 pb-2">
      <div class="relative">
        <input
          ...
          class="w-full bg-zinc-900 text-white placeholder-zinc-500 rounded-xl px-4 py-3 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-600"
        ...
        {#if searchQuery}
          <button
            ...
            onclick={() => { searchQuery = ''; loadPopular(); }}
