...
interface ProviderLogosType {
    providers: Record<string, ProviderInfo>;
    getProvider: (providerName: string) => ProviderInfo;
    getDefaultProvider: () => ProviderInfo;
    getProviderStyle: (providerName: string) => ProviderStyle;
}

const ProviderLogos: ProviderLogosType = {
...
// Export to App namespace and window
if (typeof window !== 'undefined') {
    const App = (window as any).App || {};
    App.ProviderLogos = ProviderLogos;
    (window as any).App = App;
    (window as any).ProviderLogos = ProviderLogos;
}
